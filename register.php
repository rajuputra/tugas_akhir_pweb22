...
<style type="text/css">
    ...
    <form action="" method="post" class="log-in" autocomplete="off"> 
      ...
      <div class="floating-label">
        <input placeholder="ulangi password" type="password" name="ulangi_password" id="ulangi_password" autocomplete="off">
        <label for="ulangi_password">ulangi password:</label>
      </div>
      <a class="dftr" href="index.php">Kembali ke Home? </a>
